...
const PositionSizing = () => {
    return (
        <div className="positionSizing container">
            <h1>This is position sizing page and Risk management</h1>
            <p>Position sizing is how much of your capital is allocated to each trade.</p>
            <p>Position sizing depends on your total trading capital, how your overall portfolio is performing. If you
                ...
                capital is lesser performing stocks.</p>
            <p>Yes, it is risky to only have maximum of 10 stocks and any one of the stocks can have significant
            ...
            <p> Furthermore, if your portfolio is not acting well(maybe there are more failure than successful
                trades recently), do not even allocate 5% at first. Maybe start with 2.5% position and then bump it to
                5% and then to 10%.
            </p>
            <p>Do not risk too much of your trading capital on a single trade. So how much is too much? Do not risk more
                than 1% of your portfolio on a single trade. That means, of the $10,000 capital, do not risk more than
                $100 on a single trade. How do you implement that? - through stop-loss. This is the single most
