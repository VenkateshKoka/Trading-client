    ...
    return (
        <div className="selection container">
            ...
            <p className="selection__content">
                ...
                <div className="information information__important">
                    <div>1. The current stock price is above both the 150-day (30-week) and the 200-day
                        (40-week) moving average price lines.
                    </div>
                    <div>2. The 150-day moving average is above the 200-day moving average.</div>
                    <div>3. The 200-day moving average line is trending up for at least 1 month (preferably
                        4–5 months minimum in most cases).
                    </div>
                    <div>4. The 50-day (10-week) moving average is above both the 150-day and 200-day
                        moving averages.
                    </div>
                    <div>5. The current stock price is trading above the 50-day moving average.</div>
                    <div>6. The current stock price is at least 30 percent above its 52-week low. (Many of
                    ...
                    <div>7. The current stock price is within at least 25 percent of its 52-week high (the
                        closer to a new high the better).
                    </div>
                    <div>8. The relative strength ranking (as reported in Investor’s Business Daily) is no
