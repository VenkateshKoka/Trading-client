...
const BulbBlinking = () => {
    ...
    return (
        <div className="bulbBlinking">
            <svg id="bulb-svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="bulb" className="bulb">
                    <path id="bulb_body" fill="#FFFFFF" stroke="#3D3D3D" strokeWidth="3" strokeLinecap="square"
                          strokeMiterlimit="10"
                          d="M138,86.465
		...
		c0,1.781,1.449,3.229,3.238,3.229h42.12c1.789,0,3.24-1.445,3.24-3.229v-12.91C131.637,111.384,138,99.665,138,86.465z"/>
                    <g id="sockel">
                        <path fill="#96BF1F" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="square"
			...
			C117.545,155.926,119.013,157.389,119.013,159.191L119.013,159.191z"/>
                        <path fill="none" stroke="#FFFFFF" strokeWidth="3" strokeMiterlimit="10" d="M89.111,168.988c0,4.093,3.851,7.41,8.602,7.41
			c4.75,0,8.603-3.317,8.603-7.41"/>
                        <path fill="none" stroke="#FFFFFF" strokeWidth="3" strokeMiterlimit="10" d="M81.116,162.457v3.266
		...
		c-3.105,0-5.625-2.435-5.625-5.438"/>
                ...
                <g id="light" style={{opacity: "1"}}>
                    ...
                    <line fill="none" stroke="#faf73a" strokeWidth="3" strokeLinecap="square" strokeMiterlimit="10"
